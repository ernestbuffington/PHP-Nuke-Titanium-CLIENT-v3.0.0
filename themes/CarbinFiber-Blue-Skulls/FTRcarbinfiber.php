...
//echo '<div class="flex-item" style="width: 58px; height: 71px; background-image: url('.blue_skulls_ftr_images.'FTR_Copyright.png); padding-right: 20px;">';
echo '<div align="center" style="padding-top:0px;">';

echo '<a class="copyright" href="javascript: void(0)" onclick="window.open(\''.blue_skulls_theme_dir.'copyrights.php\', \'windowname1\', \'width=800, height=500\'); return false;">';
echo '<span class="tooltip-html" title="'.blue_skulls_copyright_click.'">CarbonFiber Theme Design By Ernest Allen Buffington &copy; 2019</span>';
echo '</a>';
...
echo '<div class="tooltip-html center" style="font-size: xx-small;" title="'.blue_skulls_copyright.'"><span style="color: #141B05;">'.str_replace('<br />', '', 'CarbonFiber By: Ernest Allen Buffington &copy; 2019').'</span></div>';
echo '</div>';
echo '</section>';
echo '</td>';
