...
define('blue_skulls_phpstyle_dir', blue_skulls_theme_dir.'css/'); //Titanium Themes Only
...
//addPHPCSSToHead(blue_skulls_phpstyle_dir.'body.php','file'); //Titanium Themes Only
addPHPCSSToHead(blue_skulls_phpstyle_dir.'maintable.php','file'); //Titanium Themes Only
