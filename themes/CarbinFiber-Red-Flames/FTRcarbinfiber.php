...
echo '<a class="copyright" href="javascript: void(0)" onclick="window.open(\''.carbinfiber_red_flames_theme_dir.'copyrights.php\', \'windowname1\', \'width=800, height=500\'); return false;">';
echo '<span class="tooltip-html" title="'.carbinfiber_red_flames_copyright_click.'">CarbonFiber Theme Design By Ernest Allen Buffington &copy; 2019</span>';
echo '</a>';
...
echo '<div class="tooltip-html center" style="font-size: xx-small;" title="'.carbinfiber_red_flames_copyright.'"><span style="color: #141B05;">'.str_replace('<br />', '', 'CarbonFiber By: Ernest Allen Buffington &copy; 2019').'</span></div>';
echo '</div>';
echo '</section>';
echo '</td>';
